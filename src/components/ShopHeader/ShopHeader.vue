<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      <!-- 防止还没有请求到图片的时候报错https://delivery-yolo.oss-cn-beijing.aliyuncs.com/undefined -->
      <div
        class="content-image"
        :style="{
          backgroundImage: `url(https://delivery-yolo.oss-cn-beijing.aliyuncs.com/${
            shop.pic || 'placeholder.webp'
          })`,
        }"
      ></div>
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail speciallen">
            {{ shop.descs }}
          </span>
          <span class="shop-message-detail">约20分钟</span>
...
export default {
  ...
  mounted() {
    this.$store.dispatch("getheader", this.id);
  },
};
</script>
